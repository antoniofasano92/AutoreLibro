...
/**
 * Servlet implementation class ExecuteDettagliLibroServlet
 */
public class ExecuteDettagliLibroServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ExecuteDettagliLibroServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Integer idInt= u.parseIntFromString(parametroIdLibro);
		...
		try {
			...
			Libro libro=libroDAO.singoloLibroConAutoreCompleto(idInt);
			
			request.setAttribute("idLibroAttributeName", libro);
			destinazione = "visualizzaDettaglioLibro.jsp";
